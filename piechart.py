...
def deck_comp_chart(output_file,
    ...
    for i in range(len(icons)):
        if composition[icons[i]] >= 0:
            ...
            plt.text(center+shift, 3.8, str(composition[icons[i]]),
    ...
    lines, labels = plt.thetagrids(
        [(360./size)*i for i in range(size)], [])
    ...
    plt.savefig(output_file, bbox_inches = 'tight',pad_inches = .1)
